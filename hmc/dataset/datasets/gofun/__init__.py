...
def get_dataset_paths(dataset_type='arff'):
    if dataset_type == 'arff':
        datasets = {
            ...
            'cellcycle_FUN': (
                False,
                os.environ['DATA_FOLDER'] + '/data//HMC_data_arff/datasets_FUN/cellcycle_FUN/cellcycle_FUN.train.arff',
                os.environ['DATA_FOLDER'] + '/data//HMC_data_arff/datasets_FUN/cellcycle_FUN/cellcycle_FUN.valid.arff',
                os.environ['DATA_FOLDER'] + '/data//HMC_data_arff/datasets_FUN/cellcycle_FUN/cellcycle_FUN.test.arff'
            ),
            'derisi_FUN': (
                False,
