...
class ConstrainedMpFFNNModel(nn.Module):
    """ C-HMCNN(h) model - during training it returns the not-constrained output that is then passed to MCLoss """
    def __init__(self, input_dim, hidden_dim, output_dim, hyperparams, R,  dev0, dev1):
        super(ConstrainedMpFFNNModel, self).__init__()
        self.dev0 = dev0
        self.dev1 = dev1
