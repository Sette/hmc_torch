...
def main():
    ...
    args.input_dims = {'diatoms': 371, 'enron': 1001, 'imclef07a': 80, 'imclef07d': 80, 'cellcycle': 77, 'derisi': 63,
    ...
    output_dims_FUN = {'cellcycle': 499, 'derisi': 499, 'eisen': 461, 'expr': 499, 'gasch1': 499, 'gasch2': 499,
                       'seq': 499, 'spo': 499}
    output_dims_GO = {'cellcycle': 4122, 'derisi': 4116, 'eisen': 3570, 'expr': 4128, 'gasch1': 4122,
                      'gasch2': 4128, 'seq': 4130, 'spo': 4116}
    output_dims_others = {'diatoms': 398, 'enron': 56, 'imclef07a': 96, 'imclef07d': 46, 'reuters': 102}
    args.output_dims = {'FUN': output_dims_FUN, 'GO': output_dims_GO, 'others': output_dims_others}
    ...
    args.hidden_dims = {'FUN': hidden_dims_FUN, 'GO': hidden_dims_GO, 'others': hidden_dims_others}
